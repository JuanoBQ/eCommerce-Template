          ...
          <div className="max-w-md">
            ...
            <form onSubmit={handleNewsletterSubscribe} className="flex space-x-3">
              <input
                ...
                className="flex-1 px-4 py-2 bg-gray-900 border border-gray-700 rounded-md text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-transparent"
                disabled={isSubscribing}
              />
              <button 
                type="submit"
                disabled={isSubscribing}
                className="bg-primary-500 text-white px-6 py-2 rounded-md hover:bg-primary-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-4 md:space-y-0">
            ...
            <div className="flex items-center space-x-2 text-gray-400 text-sm">
              ...
              <div className="flex items-center space-x-1">
                <div className="w-8 h-5 bg-gray-800 rounded text-xs flex items-center justify-center">VISA</div>
                <div className="w-8 h-5 bg-gray-800 rounded text-xs flex items-center justify-center">MC</div>
                <div className="w-8 h-5 bg-gray-800 rounded text-xs flex items-center justify-center">PP</div>
              </div>
            </div>
          </div>
        </div>
