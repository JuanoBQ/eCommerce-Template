...
MIDDLEWARE = [
    ...
    'ecommerce.middleware.JWTAuthenticationMiddleware',  # Middleware JWT personalizado ANTES de AuthenticationMiddleware
...
ACCOUNT_EMAIL_VERIFICATION = 'none'  # Cambiado a 'none' para desarrollo
